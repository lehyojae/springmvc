  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <!--   <li class="dropdown">
        ...
        <li><a href="/serverweb/member_mvc/search.jsp">인사관리</a></li>
        <li><a href="#">고급기능</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/springmvc/tiles/insert"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
        <li><a href="/springmvc/tiles/login"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
      </ul>
    </div>
  </div>
</nav>
